...
function shopstar_customizer_library_options() {
    ...
    $options['shopstar-default-slider-info'] = array(
    	...
    	'section' => $section,
    	'type'    => 'info',
    	'description' => __( '<a href="http://www.outtheboxthemes.com/documentation/shopstar/homepage-slider/default-slider/" target="_blank">Read a guide on how to set up the Default Slider</a>', 'shopstar' ),
    );
    ...
    $options['shopstar-slider-plugin-info'] = array(
    	...
    	'section' => $section,
    	'type'    => 'info',
    	'description' => __( '<a href="http://www.outtheboxthemes.com/documentation/shopstar/homepage-slider/slider-plugin/" target="_blank">Read a guide on using a slider plugin</a>', 'shopstar' ),
    );
    ...
    $options['shopstar-heading-font-weight'] = array(
    	...
    	'label'   => __( 'Heading Font Weight', 'shopstar' ),
    	'section' => $section,
    	'type'    => 'select',
    	'choices' => $choices,
    	'default' => '300'
